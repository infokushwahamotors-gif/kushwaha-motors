...
const DEALERS = [
  { city: { ne: "वीरगन्ज", en: "Birgunj" }, location: { ne: "पर्सा", en: "Parsa" }, phone: "9821107355", type: "Head Office", isHead: true },
  { city: { ne: "कलैया", en: "Kalaiya" }, location: { ne: "बारा", en: "Bara" }, phone: "9802595086", type: "Branch" },
  { city: { ne: "सिमरा", en: "Simara" }, location: { ne: "बारा", en: "Bara" }, phone: "9812212699", type: "Branch" },
  { city: { ne: "सुकदेव चोक", en: "Sukdew Chowk" }, location: { ne: "रौतहट", en: "Rautahat" }, phone: "9801287097", type: "Branch" },
  { city: { ne: "हेटौंडा", en: "Hetauda" }, location: { ne: "मकवानपुर", en: "Makwanpur" }, phone: "9801235567", type: "Branch" },
  { city: { ne: "टाँडी", en: "Tandi" }, location: { ne: "चितवन", en: "Chitwan" }, phone: "9843596487", type: "Branch" },
  { city: { ne: "भरतपुर", en: "Bharatpur" }, location: { ne: "चितवन", en: "Chitwan" }, phone: "9812287436", type: "Branch" },
  { city: { ne: "मलंगवा", en: "Malangwa" }, location: { ne: "सर्लाही", en: "Sarlahi" }, phone: "9866388988", type: "Branch" },
];

const ADDITIONAL_LOCATIONS = [
  { ne: "दमक, झापा", en: "Damak, Jhapa" },
  { ne: "विराटचोक, मोरङ", en: "Biratchowk, Morang" },
  { ne: "धरान, सुनसरी", en: "Dharan, Sunsari" },
  { ne: "लहान, सिराहा", en: "Lahan, Siraha" },
  { ne: "लालबन्दी, सर्लाही", en: "Lalbandi, Sarlahi" },
  { ne: "हरिवन, सर्लाही", en: "Hariwon, Sarlahi" },
  { ne: "चपुर, रौतहट", en: "Chapur, Rautahat" },
  { ne: "बुटवल, रुपन्देही", en: "Butwal, Rupandehi" },
              ...
              {filteredDealers.map((d, index) => (
                ...
                >
                  ...
                  <a href={`tel:${d.phone}`} className="btn-outline" style={{ textAlign: 'center', textDecoration: 'none', marginTop: 4 }}>
                    {t.contactBtn} <ArrowRight size={14} />
                  </a>
                </motion.div>
              ))}
            </motion.div>
        ...
        <section style={{ padding: '40px 0 120px' }}>
          <div className="container">
            <div style={{ 
              ...
              <p style={{ color: 'var(--txt-2)', marginBottom: 40, fontSize: '1.1rem' }}>{language === 'ne' ? 'हाम्रा आधिकारिक डिलरहरू निम्न स्थानहरूमा पनि उपलब्ध छन्।' : 'Our authorized dealers are also available in the following locations.'}</p>
      ...
      <section style={{ padding: '40px 0 100px' }}>
        <div className="container">
          <div style={{ 
            ...
            <div style={{ height: 600, width: '100%', position: 'relative', background: '#e5e3df' }}>
              {/* Google Maps Embed focused on Nepal/Birgunj area where many branches are */}
              <iframe
                title="Kushwaha Motors Locations"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113941.56499645932!2d84.80801833549641!3d26.97723903175245!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399355152a5c531d%3A0xe5f99233f260464f!2sKushwaha%20Motors!5e0!3m2!1sen!2snp!4v1715227000000!5m2!1sen!2snp"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
